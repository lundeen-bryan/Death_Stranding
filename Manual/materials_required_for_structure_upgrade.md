...
You can check the number and type of materials required in order to upgrade a given structure by moving the cursor over the corresponding icon on the map.
